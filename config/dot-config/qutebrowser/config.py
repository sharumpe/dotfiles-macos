...
# Overall, accept no-unknown-3rdparty
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, f'file://{user_home}/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, f'file://{user_home}/.local/share/qutebrowser/userscripts/*')
